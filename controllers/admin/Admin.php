<?php
require_once $_SERVER['DOCUMENT_ROOT'].'/CRM/models/admin.php';
...
if($_POST || @$_GET['action'])
{
    ...
    if(isset($_POST['addAdmin']))
    {
        ...
        if($id == null)
        {
            ...
            if($formErrors != null )
                require_once $_SERVER['DOCUMENT_ROOT'].'/CRM/views/admin/Admin.php';  
...
else // display all admin 
{
    ...
    require_once $_SERVER['DOCUMENT_ROOT'].'/CRM/views/admin/showAdmins.php';  
}      
