...
require_once $_SERVER['DOCUMENT_ROOT'].'/CRM/models/employee.php';
...
if(isset ($_POST['SaveComplaint']))
{
    if(isset($_POST['description']))
    {
        ...
        if($result)
        {
            ...
            require_once $_SERVER['DOCUMENT_ROOT'].'/CRM/views/customer/makeComplaint.php';
        }
        else
        {
...
else if(isset ($_POST['rate']))
{
    ...
    require_once $_SERVER['DOCUMENT_ROOT'].'/CRM/views/customer/rate.php';            
}
...
{ //----------------------DELETE COMPLAINT ---------------------------------------
    ...
    require_once $_SERVER['DOCUMENT_ROOT'].'/CRM/views/customer/complaint.php';            
}
